...
use crate::{app_context::AppContext, lightning_fetcher::{self, LightningResponse}};
...
pub fn run_ingestor(context: AppContext) -> JoinHandle<()>
{
    ...
    .expect("msg").parse::<u64>().expect("Please provide a valid i32 in FETCH_INTERVAL_IN_SECS");
    ...
    tokio::spawn(async move {
        loop {
            ...
            if data.is_ok() {
                ...
                println!("An error occurred when fetching data: {}", data.unwrap_err());
            }
